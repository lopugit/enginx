...
args.scripts = {
	...
	syncVolumes: `
		...
		sudo docker cp -L /things/statics syncVolumes:/things/ ;
	...
	enginxjs: `
		...
		-v letsencrypt:/enginxjs/output/perm/letsencrypt \
		-v certs:/enginxjs/output/perm/certs \
		--name enginxjs enginxjs \
		node node/index.js --generateConfigs --nosync ${args.host ? '--host '+args.host : ''} --notall;
		docker rm --force enginxjs ;
	`,
	enginx: `
		...
		-v things:/things \
		-v /things/statics:/things/statics \
		-v sites:/things/tmp/sites \
		-v certbotwww:/things/perm/certbotwww \
		-v letsencrypt:/things/perm/letsencrypt \
		-v certs:/things/perm/certs \
