...
if((args.host || args.prod || args.nobuild || args.nocertbot) && !args.notall) args.all = true
if(args.prod) args.host = 'enginx' ; 
if(args.dev) args.nocertbot = args.certbot ? false : true ; args.noenginx = true
...
args.scripts = {
	...
	enginxjs: `
		...
		node node/index.js --generateConfigs ${args.host ? '--host '+args.host : ''} --notall;
		docker rm --force enginxjs ;
	`,
	enginx: `
...
if((args.enginx || args.all) && !args.noenginx){
...
if(args.dev){
	...
	shell.exec(`
		...
		sudo cp ./assets/nginx.vh.default.mac.conf /usr/local/etc/openresty/conf.d/ ;
		renginx
	`)
}
