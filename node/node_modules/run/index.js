...
if((args.syncVolumes || args.all) && !args.nodocker){
...
if(args.dev && !args.dryrun){
	console.log('running cpdev')
	shell.exec(`
		sudo mkdir -p /usr/local/etc/openresty/certs/ /usr/local/etc/openresty/conf.d/ /usr/local/etc/openresty/sites-enabled/ ;
