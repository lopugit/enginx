		...
		if(site.self_signed){
			...
			if(cert){
				...
				server {
					...
					ssl_certificate         /usr/local/etc/openresty/certs/${site.server_name}/crt.pub.pem ;
					ssl_certificate_key     /usr/local/etc/openresty/certs/${site.server_name}/crt.priv.pem ;
				`
				if(site.ip){
					file += `
						location / {
