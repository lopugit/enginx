...
function exportF(args){
	...
	for(var site of sites){
		...
		if(site.self_signed){
			...
			if(cert){
				file += `
					ssl_certificate         /things/perm/certs/${site.server_name}/crt.pub.pem ;
					ssl_certificate_key     /things/perm/certs/${site.server_name}/crt.priv.pem ;
				`
			}
			...
			try {
				...
				file += `
					ssl_certificate         /things/perm/certs/certbot/${site.server_name}/fullchain.pem ;
					ssl_certificate_key     /things/perm/certs/certbot/${site.server_name}/privkey.pem ;
